module "vpc" {
  ...
  public_subnets  = ["10.0.12.0/27", "10.0.12.32/27", "10.0.12.64/27"]     # Reserve 90 IP addresses for public subnets
  private_subnets = ["10.0.12.160/27", "10.0.12.192/27", "10.0.12.224/27"] # Reserve 90 IP addresses for private subnets
